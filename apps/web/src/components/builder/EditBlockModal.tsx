    ...
    <>
      ...
      <label className="block">
        ...
        <input
          ...
          onChange={(e) => { const v = parseInt(e.target.value); handleConfigChange("maxItems", Number.isNaN(v) ? 5 : v); }}
          className="mt-1 block w-full rounded border border-border bg-background px-3 py-2 text-sm"
        />
      </label>
    ...
    <>
      ...
      <label className="block">
        ...
        <input
          ...
          onChange={(e) => { const v = parseInt(e.target.value); handleConfigChange("maxItems", Number.isNaN(v) ? 10 : v); }}
          className="mt-1 block w-full rounded border border-border bg-background px-3 py-2 text-sm"
        />
      </label>
