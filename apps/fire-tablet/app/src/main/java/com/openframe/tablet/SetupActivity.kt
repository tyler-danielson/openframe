...
class SetupActivity : AppCompatActivity() {
    ...
    private lateinit var kioskLockToggle: CheckBox
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Pre-fill kiosk lock toggle
        kioskLockToggle.isChecked = prefs.getBoolean(KioskLockManager.PREF_KIOSK_LOCK, false)
    ...
    private fun bindViews() {
        ...
        kioskLockToggle = findViewById(R.id.kioskLockToggle)
    }
    ...
    private fun updateInstructions(step: Int) {
        instructionsText.text = when (step) {
            STEP_QR -> """
                ...
                The tablet will connect automatically once approved.
            ...
            STEP_MANUAL -> """
                ...
                Admin Access:
                Triple-tap the top-right corner of the kiosk screen to return to this setup.
            """.trimIndent()
            else -> """
                OpenFrame Tablet Kiosk Setup

                Enter your OpenFrame server URL to get started. You'll be able to pair this tablet by scanning a QR code with your phone.
    ...
    private fun saveManualSettings() {
        ...
        prefs.edit()
            ...
            .putBoolean(KioskLockManager.PREF_KIOSK_LOCK, kioskLockToggle.isChecked)
            .apply()
