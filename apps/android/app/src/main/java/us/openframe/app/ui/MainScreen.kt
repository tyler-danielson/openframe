...
enum class AppScreen(
    ...
    RECIPES("recipes", "Recipes", Icons.Filled.MenuBook, Icons.Outlined.MenuBook),
    HOME_ASSISTANT("homeassistant", "Home Assistant", Icons.Filled.Bolt, Icons.Outlined.Bolt),
    ...
    WEATHER("weather", "Weather", Icons.Filled.WbCloudy, Icons.Outlined.WbCloudy),
